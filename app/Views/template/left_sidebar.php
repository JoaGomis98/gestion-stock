        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li><a href="<?= base_url() ?>gestionUtilisateur"
                        class="<?= (current_url() == base_url('gestionUtilisateur')) ? 'active' : '' ?>"><i
                            class="md ion-checkmark"></i><span>Utilisateurs</span></a></li>
                <li><a href="<?= base_url() ?>endpoints"
                        class="<?= (current_url() == base_url('endpoints')) ? 'active' : '' ?>"><i
                            class="md ion-checkmark"></i><span>Produits</span></a></li>
                <!-- <li><a href="<?= base_url() ?>authentification"
                 ...
                 <li>
                    <a href="<?= base_url() ?>index"
                        class="waves-effect <?= (current_url() == base_url('index')) ? 'active' : '' ?>"><i
                            class="md md-home"></i><span> Catégories </span></a>
                </li>

                 <li>
                    <a href="<?= base_url() ?>index"
                        class="waves-effect <?= (current_url() == base_url('index')) ? 'active' : '' ?>"><i
                            class="md md-home"></i><span> Fournisseurs </span></a>
                </li>
